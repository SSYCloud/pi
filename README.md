...
Pi upstream 是 self extensible coding agent mono repo。更多 upstream 贡献规则见 [CONTRIBUTING.md](CONTRIBUTING.md) 和 [AGENTS.md](AGENTS.md)。

Pi 默认不内置文件系统、进程、网络或凭据权限隔离。如果需要更强边界，可以参考 [containerization guide](packages/coding-agent/docs/containerization.md) 使用 OpenShell、Gondolin extension 或 Docker。
